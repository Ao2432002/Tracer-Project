...
function filterBoxes() {
  var acdDropdown = document.getElementById("acd-year");
  var acdSelectedValue = acdDropdown.value;
  ...
  for (var i = 0; i < students.length; i++) {
    ...
    var acdYearSpan = student.querySelector(".info h4:nth-of-type(4) span");
    var acdYear = acdYearSpan.textContent.trim();

    var sectionSpan = student.querySelector(".info h4:nth-of-type(5) span");
    var section = sectionSpan.textContent.trim();

    if (
      (acdSelectedValue === "all" || acdYear === acdSelectedValue) &&
      (sectionSelectedValue === "all" || section === sectionSelectedValue)
    ) {
