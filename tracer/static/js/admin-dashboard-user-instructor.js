...
function filterBoxes() {
  ...
  var departmentSelectedValue = departmentDropdown.value;


  var boxes = document.getElementById("boxes");
  var instructors = boxes.getElementsByClassName("box");

  for (var i = 0; i < instructors.length; i++) {
    var instructor = instructors[i];
    
    var departmentSpan = instructor.querySelector(".info h4:nth-of-type(4) span");
    var department = departmentSpan.textContent.trim();

    if ((departmentSelectedValue === "all" || department === departmentSelectedValue)) {
